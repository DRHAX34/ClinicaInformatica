Public Class OPR_Utilizadores
    ...
    'Private Sub naocheck_CheckedChanged(sender As Object, e As EventArgs)
    ...
    'Private Sub simcheck_CheckedChanged(sender As Object, e As EventArgs)
    ...
    'Private Sub admgeralcheck_CheckedChanged(sender As Object, e As EventArgs)
    ...
    Private Sub addtecnicobox_Click(sender As Object, e As EventArgs)
    ...
    Private Sub empresabox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles empresabox.SelectedIndexChanged
